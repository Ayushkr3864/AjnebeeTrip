...
useEffect(() => {
  ...
  const ref = doc(db, "Upcommingtrips", id);
      ...
      <section className="relative h-[60vh]">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full max-w-6xl mx-auto px-6 text-white">
          ...
          >
            ...
            <div className="  top-6 right-6 z-20">
              {status === "available" && (
      ...
      >
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <p className="text-sm text-gray-500 mb-2">📅 Booking Deadline</p>
            <p className="font-bold text-2xl text-gray-800">
              {trip.bookingDeadline || 0}
            </p>
          </motion.div>
        </div>
        {/* DESCRIPTION CARD */}
          ...
          <div className="bg-white/80 backdrop-blur-lg shadow-xl rounded-2xl p-6 border border-white/50">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                <FaCloudSun className="text-blue-500 text-xl mt-1" />
                <div>
                  <p className="font-semibold text-gray-800">Weather</p>
                  <p className="text-gray-600 capitalize">
                    {trip?.importantInfo.weather}
                  </p>
                </div>
              </div>
              ...
              {/* ID Proof */}
              <div className="flex items-start gap-3">
                <FaIdCard className="text-indigo-500 text-xl mt-1" />
                <div>
                  <p className="font-semibold text-gray-800">ID Proof</p>
                  <p className="text-gray-600">{trip?.importantInfo.idProof}</p>
                </div>
              </div>

              {/* What to Carry */}
              <div className="flex items-start gap-3">
                <FaSuitcase className="text-green-500 text-xl mt-1" />
                <div>
                  <p className="font-semibold text-gray-800">What to Carry</p>
                  <p className="text-gray-600">
                    {trip?.importantInfo.whatToCarry}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {trip?.importantInfo.cancellation}
                  </p>
                </div>
              </div>
            </div>
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "dates" && (
              ...
              >
                ...
                {trip.batchDates?.length > 0 ? (
                  <div className="flex flex-wrap gap-3">
                    {trip.batchDates.map((d, i) => (
                      <motion.span
                        key={i}
        ...
        >
          ...
          <table className="w-full text-sm border-collapse overflow-hidden rounded-xl">
            <thead className="bg-indigo-600 text-white">
              <tr>
                <th className="p-4 text-left font-semibold">Offer</th>
                <th className="p-4 text-right font-semibold">Price</th>
              </tr>
            </thead>
            <tbody className="bg-white">
              <tr className="border-t border-gray-200">
                <td className="p-4 font-medium text-gray-700">Early Bird</td>
                <td className="p-4 text-right font-bold text-gray-800">
                  ₹{trip.pricingDetails?.earlyBird}
                </td>
              </tr>
              <tr className="border-t border-gray-200">
              ...
              <tr className="border-t border-gray-200">
                <td className="p-4 font-medium text-gray-700">Payment Type</td>
                <td className="p-4 text-right font-bold text-gray-800">
                  {trip.pricingDetails?.paymentType}
                </td>
              </tr>
            </tbody>
          </table>
